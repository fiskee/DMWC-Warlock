...
function Warlock.Settings()
    ...
    UI.AddDropdown("Curse", nil, {"Disabled", "Curse of Agony", "Curse of Shadow", "Curse of the Elements", "Curse of Recklessness", "Curse of Weakness", "Curse of Tongues", "Curse of Idiocy", "Curse of Doom"}, 2, true)
    ...
    UI.AddToggle("Luffa", "Auto use luffa trinket", true, true)
